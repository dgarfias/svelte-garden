<script lang="ts">
  ...
  // -- BUTTONS --
  import { Button, IconButton, ToggleButton, ToggleIconButton, SplitButton, Anchor } from '$lib/buttons';

  // -- FORMS --
  import {
    Field, Fieldset, Legend, Label, Hint, Message,
    Input, MediaInput, FauxInput, Textarea, Select,
    Checkbox, Radio, Toggle, Range,
    FileUpload, FileList, FileListItem, File, FileClose, FileDelete,
    Tiles, Tile, TileIcon, TileLabel, TileDescription
  } from '$lib/forms';

  // -- MODALS --
  import { Modal, ModalHeader, ModalBody, ModalFooter, ModalClose } from '$lib/modals';
  ...
  // -- TYPOGRAPHY --
  import { Heading, Paragraph, Span, Code, CodeBlock, Blockquote, OrderedList, UnorderedList } from '$lib/typography';
  ...
  // -- TABLES --
  import { Table, TableHead, TableBody, TableRow, TableHeaderCell, TableCell, Caption } from '$lib/tables';

  // -- ACCORDIONS --
  import { Accordion, AccordionSection, AccordionHeader, AccordionPanel } from '$lib/accordions';

  // -- GRID --
  import { Grid, Row, Col } from '$lib/grid';

  // -- PAGINATION --
  import { OffsetPagination, CursorPagination, CursorFirst, CursorPrevious, CursorNext, CursorLast } from '$lib/pagination';
  ...
  // -- DRAGGABLE --
  import { Draggable, DraggableGrip, DraggableContent, DraggableList, Dropzone } from '$lib/draggable';
  ...
  <div class="content">
    ...
    <section id="buttons" class="section">
      ...
      <div class="demo-block">
        ...
        <div class="demo-row">
          <IconButton aria-label="Settings">{@html icons.settings}</IconButton>
          <IconButton isPrimary aria-label="Add">{@html icons.plus}</IconButton>
          <IconButton isDanger aria-label="Delete">{@html icons.trash}</IconButton>
          <IconButton isBasic aria-label="Star">{@html icons.star}</IconButton>
          <IconButton isPill aria-label="Search">{@html icons.search}</IconButton>
        </div>
      </div>
      ...
      <div class="demo-block">
        ...
        <div class="demo-row">
          <ToggleButton isPressed={isTogglePressed} onclick={() => isTogglePressed = !isTogglePressed}>
            {isTogglePressed ? 'Pressed' : 'Not Pressed'}
          </ToggleButton>
          <ToggleIconButton 
            isPressed={isIconTogglePressed} 
            onclick={() => isIconTogglePressed = !isIconTogglePressed}
            aria-label="Favorite"
          >
            {@html icons.star}
          </ToggleIconButton>
          <span class="state-label">Toggle: {isTogglePressed}, Icon: {isIconTogglePressed}</span>
        </div>
      </div>
      ...
      <div class="demo-block">
        ...
        <div class="demo-row">
          <SplitButton>
            ...
            <IconButton isPrimary aria-label="More options">{@html icons.chevronDown}</IconButton>
          </SplitButton>
        </div>
      </div>
      ...
      <div class="demo-block">
        ...
        <Paragraph>
          Here is an <Anchor href="#">inline link</Anchor>, a <Anchor href="#" isDanger>danger link</Anchor>, 
          and an <Anchor href="https://example.com" isExternal>external link</Anchor>.
        </Paragraph>
      </div>
    </section>
    ...
    <section id="forms" class="section">
      ...
      <div class="demo-block">
        ...
        <div class="form-grid">
          <Field>
            ...
            <Input placeholder="Type here..." value={inputValue} oninput={(e) => inputValue = e.currentTarget.value} />
          </Field>
          <Field>
      ...
      <div class="demo-block">
        ...
        <div class="form-grid">
          ...
          <Field>
            ...
            <Message validation="error">This field has an error</Message>
          </Field>
        </div>
      </div>
      ...
      <div class="demo-block">
        ...
        <Field>
          ...
          <FauxInput>This looks like an input but isn't editable</FauxInput>
        </Field>
      </div>
      ...
      <div class="demo-block">
        ...
        <Field>
          ...
          <Textarea placeholder="Write something..." value={textareaValue} oninput={(e) => textareaValue = e.currentTarget.value} rows={4} />
        </Field>
      </div>
      ...
      <div class="demo-block">
        ...
        <Field>
          ...
          <Select value={selectValue} onchange={(e) => selectValue = e.currentTarget.value}>
      ...
      <div class="demo-block">
        ...
        <div class="stack">
          <Checkbox checked={checkboxChecked} onchange={() => checkboxChecked = !checkboxChecked}>
      ...
      <div class="demo-block">
        ...
        <div class="stack">
          <Radio name="demo-radio" value="option1" checked={radioValue === 'option1'} onchange={() => radioValue = 'option1'}>
            Option 1
          </Radio>
          <Radio name="demo-radio" value="option2" checked={radioValue === 'option2'} onchange={() => radioValue = 'option2'}>
            Option 2
          </Radio>
          <Radio name="demo-radio" value="option3" checked={radioValue === 'option3'} onchange={() => radioValue = 'option3'}>
            Option 3
          </Radio>
        </div>
      ...
      <div class="demo-block">
        ...
        <div class="stack">
          <Toggle checked={toggleChecked} onchange={() => toggleChecked = !toggleChecked}>
      ...
      <div class="demo-block">
        ...
        <Field>
          ...
          <Range min={0} max={100} step={1} value={rangeValue} oninput={(e) => rangeValue = Number(e.currentTarget.value)} />
        </Field>
      </div>
      ...
      <div class="demo-block">
        ...
        <FileList>
          ...
          <FileListItem>
            <File type="document" validation="success">approved.docx</File>
          </FileListItem>
          <FileListItem>
            <File type="document" validation="error">invalid.pdf</File>
          </FileListItem>
        </FileList>
      </div>
    ...
    <section id="typography" class="section">
      ...
      <div class="demo-block">
        ...
        <Paragraph size="small">Small paragraph for secondary content.</Paragraph>
...
console.log(greet('World'));`}
    ...
    <section id="avatars" class="section">
      ...
      <div class="demo-block">
        ...
        <div class="demo-row">
          <Avatar size="large" src="https://i.pravatar.cc/100?img=1" alt="User 1" />
          <Avatar size="large" src="https://i.pravatar.cc/100?img=2" alt="User 2" />
          <Avatar size="large" src="https://i.pravatar.cc/100?img=3" alt="User 3" />
        </div>
      </div>
    ...
    <section id="tags" class="section">
      ...
      <div class="demo-block">
        ...
        <div class="demo-row">
          <Tag>
            <TagAvatar>
              <Avatar size="extraextrasmall" src="https://i.pravatar.cc/40?img=1" />
            </TagAvatar>
            John Doe
          </Tag>
          <Tag hue="#b4a7c7">
            <TagAvatar>
              <Avatar size="extraextrasmall" src="https://i.pravatar.cc/40?img=2" />
            </TagAvatar>
            Jane Smith
            <TagClose onclick={() => {}} />
          </Tag>
    ...
    <section id="loaders" class="section">
      ...
      <div class="demo-block">
        ...
        <div class="stack">
          ...
          <div class="demo-row">
            <Button size="small" onclick={() => progressValue = Math.max(0, progressValue - 10)}>-10%</Button>
            <span>{progressValue}%</span>
            <Button size="small" onclick={() => progressValue = Math.min(100, progressValue + 10)}>+10%</Button>
          </div>
        </div>
      </div>
    ...
    <section id="notifications" class="section">
      ...
      <div class="demo-block">
        ...
        <div class="stack">
          ...
          <Alert type="warning">Warning: Please review your information.</Alert>
      ...
      <div class="demo-block">
        ...
        {#if showToast}
          <div class="toast-container">
            <Toast type="success" title="Success" onDismiss={() => showToast = false}>
    ...
    <section id="modals" class="section">
      ...
      <div class="demo-block">
        <div class="demo-row">
          ...
          <Button isDanger onclick={() => showDangerModal = true}>Danger Modal</Button>
        </div>
      </div>
    </section>
    ...
    <section id="dropdowns" class="section">
      ...
      <div class="demo-block">
        ...
        <div class="dropdown-container">
          ...
          <Menu isExpanded={showMenu} onClose={() => showMenu = false}>
            <MenuItem onclick={() => showMenu = false}>Edit</MenuItem>
            <MenuItem onclick={() => showMenu = false}>Duplicate</MenuItem>
            <MenuItem type="add" onclick={() => showMenu = false}>Add new</MenuItem>
            <MenuSeparator />
            <MenuItem type="danger" onclick={() => showMenu = false}>Delete</MenuItem>
          </Menu>
        </div>
      </div>
    </section>
    ...
    <section id="tooltips" class="section">
      ...
      <div class="demo-block">
        ...
        <div class="demo-row">
          ...
          <Tooltip content="Medium tooltip with more content" size="medium">
            <Button>Medium</Button>
          </Tooltip>
          <Tooltip content="Large tooltip that can contain even more descriptive text" size="large">
            <Button>Large</Button>
          </Tooltip>
        </div>
      </div>
    ...
    <section id="tabs" class="section">
      ...
      <div class="demo-block">
        <Tabs selectedIndex={activeTab}>
          <TabList>
            <Tab index={0} onclick={() => activeTab = 0}>Overview</Tab>
            <Tab index={1} onclick={() => activeTab = 1}>Details</Tab>
            <Tab index={2} onclick={() => activeTab = 2}>Settings</Tab>
            <Tab index={3} disabled>Disabled</Tab>
          </TabList>
          <TabPanel index={0}>
            <Paragraph>This is the overview content panel.</Paragraph>
          </TabPanel>
          <TabPanel index={1}>
            <Paragraph>This is the details content panel.</Paragraph>
          </TabPanel>
          <TabPanel index={2}>
            <Paragraph>This is the settings content panel.</Paragraph>
          </TabPanel>
          <TabPanel index={3}>
    ...
    <section id="accordions" class="section">
      ...
      <div class="demo-block">
        <Accordion>
          <AccordionSection isExpanded={accordionState.section1} onToggle={(v) => accordionState.section1 = v}>
          ...
          <AccordionSection isExpanded={accordionState.section2} onToggle={(v) => accordionState.section2 = v}>
            <AccordionHeader>How do I install it?</AccordionHeader>
            <AccordionPanel>
              <Paragraph>
                Install via npm: <Code>npm install svelte-garden</Code>
              </Paragraph>
            </AccordionPanel>
          </AccordionSection>
          <AccordionSection isExpanded={accordionState.section3} onToggle={(v) => accordionState.section3 = v}>
            <AccordionHeader>Is it accessible?</AccordionHeader>
            <AccordionPanel>
              <Paragraph>
                Yes! All components follow WCAG guidelines with proper ARIA attributes and keyboard navigation.
              </Paragraph>
            </AccordionPanel>
          </AccordionSection>
        </Accordion>
    ...
    <section id="pagination" class="section">
      ...
      <div class="demo-block">
        ...
        <CursorPagination>
          <CursorFirst disabled={cursorPage === 1} onClick={() => cursorPage = 1} />
          <CursorPrevious disabled={cursorPage === 1} onClick={() => cursorPage = Math.max(1, cursorPage - 1)} />
          <span class="cursor-label">Page {cursorPage} of 10</span>
          <CursorNext disabled={cursorPage === 10} onClick={() => cursorPage = Math.min(10, cursorPage + 1)} />
          <CursorLast disabled={cursorPage === 10} onClick={() => cursorPage = 10} />
        </CursorPagination>
      </div>
    </section>
    ...
    <section id="colorpickers" class="section">
      ...
      <div class="demo-block">
        ...
        <div class="demo-row-top">
          <ColorPicker onChange={(color) => selectedColor = color} />
          {#if selectedColor}
            <div class="color-preview">
              <div class="color-swatch" style:background-color={selectedColor.hex}></div>
              <div class="color-info">
                <div>Hex: {selectedColor.hex}</div>
                <div>RGB: {selectedColor.red}, {selectedColor.green}, {selectedColor.blue}</div>
      ...
      <div class="demo-block">
        ...
        <ColorSwatch
          ...
          onSelect={(row, col) => { swatchRow = row; swatchCol = col; }}
        />
        {#if swatchRow !== null && swatchCol !== null}
          <p class="state-label">Selected: {swatchColors[swatchRow][swatchCol].label}</p>
        {/if}
      </div>
    </section>
    ...
    <section id="datepickers" class="section">
      ...
      <div class="demo-block">
        ...
        />
        {#if selectedDate}
          <p class="state-label">Selected: {selectedDate.toLocaleDateString()}</p>
        {/if}
      </div>
      ...
      <div class="demo-block">
        ...
        />
        {#if calendarDate}
          <p class="state-label">Selected: {calendarDate.toLocaleDateString()}</p>
        {/if}
      </div>
    </section>
        ...
        <DraggableList>
          ...
          <li>
            <Draggable isDisabled>
              <DraggableGrip />
              <DraggableContent>Item 4 - Disabled</DraggableContent>
            </Draggable>
          </li>
        </DraggableList>
      </div>
...
<Modal isOpen={showModal} onClose={() => showModal = false}>
  ...
  <ModalBody>
    <Paragraph>This is the modal body. You can put any content here.</Paragraph>
  </ModalBody>
  <ModalFooter>
...
<Modal isOpen={showDangerModal} onClose={() => showDangerModal = false}>
  ...
  <ModalFooter>
    ...
    <Button isPrimary isDanger onclick={() => showDangerModal = false}>Delete</Button>
  </ModalFooter>
  <ModalClose />
</Modal>
...
<style>
  ...
  .section-title {
    ...
    margin: 0 0 24px;
    padding-bottom: 12px;
    border-bottom: 2px solid var(--garden-color-border-primary-emphasis, #1f73b7);
  }
