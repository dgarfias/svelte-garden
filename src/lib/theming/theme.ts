/**
 * Svelte Garden - Default Theme
 * 
 * The default theme configuration based on Zendesk Garden
 */

import { PALETTE } from './palette';
import type { GardenTheme, ColorVariables } from './types';
...
const darkVariables: ColorVariables = {
  background: {
...
const lightVariables: ColorVariables = {
  background: {
...
const colors = {
  base: 'light' as const,
  primaryHue: 'blue' as const,
  dangerHue: 'red' as const,
  warningHue: 'yellow' as const,
  successHue: 'green' as const,
  neutralHue: 'grey' as const,
  chromeHue: 'kale' as const,
  variables: {
    dark: darkVariables,
...
// Clone palette without product colors for theme
...
export const DEFAULT_THEME: GardenTheme = {
  borders,
  borderRadii,
  borderStyles,
  borderWidths,
